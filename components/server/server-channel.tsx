...
import { ModalType, useModal } from "@/hooks/use-modal_store";
  ...
  return (
    <div className="px-4">
      <button
        onClick={onClick}
        className={cn(
          "group mb-1 flex w-full items-center gap-x-2 rounded-md transition hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50",
